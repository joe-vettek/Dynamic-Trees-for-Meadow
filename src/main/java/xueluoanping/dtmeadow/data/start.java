package xueluoanping.dtmeadow.data;
...
import xueluoanping.dtmeadow.data.loot.DTFTLootTableProvider;

import java.util.concurrent.CompletableFuture;


public class start {
    public final static String MODID = DTMeadow.MOD_ID;
    ...
    public static void dataGen(GatherDataEvent event) {
        ...
        if (event.includeServer()) {
            DTMeadow.logger("Generate recipe");
